...
function CuadroBloques({cargando, sunrise, sunset, precipitation, relativehumidity_2m, visibility, windspeed, uv_index_max, esDeDia}) {
  ...
  return (
        <div className='cuadroBloques'>
              <div className='primeraFila'>
                <div className={`bloques ${esDeDia ? "bloqueDiurno" : "bloqueNocturno"}`}>
